...
gene_location_file_name = "../data/genes.txt";
...
# Output file name
output_file_name_cis = "../data/cisqtl.height.txt";
output_file_name_tra = "../data/transqtl.height.txt";
...
saveRDS(me, "../data/matrixqtl.height.rds")
